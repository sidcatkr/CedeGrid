...
ALLOWLIST = (
    ...
    'docs/execution-work.md',
    'docs/guarantees.md',
    'docs/kernel-assisted-delta.md',
    'docs/local-supervision-verification.md',
    'docs/migration-0.2.md',
    'docs/milestone-1-verification.md',
    'docs/release-0.2-gates.json',
    'docs/release-0.2-evidence.md',
    'docs/release-0.2-spec.md',
    'docs/release.md',
    'docs/sdk-adapter-work.md',
    'docs/soak-harness.md',
    'docs/validation.md',
    ...
    'examples/counter.c',
    'examples/cpu-job.json',
    'examples/gpu-pressure.json',
    'examples/gpu_counter.c',
    'examples/node.toml',
    'examples/status_benchmark_probe.rs',
    'npm/LICENSE',
    'npm/NOTICE',
    'npm/README.md',
    'npm/THIRD_PARTY_NOTICES.md',
    'npm/examples/counter.ts',
    'npm/package-lock.json',
    'npm/package.json',
    'npm/scripts/build.ts',
    'npm/scripts/verify-packages.ts',
    'npm/src/client.ts',
    'npm/src/codec.ts',
    'npm/src/config.ts',
    'npm/src/errors.ts',
    ...
    'npm/src/launcher.ts',
    'npm/src/worker.ts',
    'npm/tests/numeric-interop.ts',
    'npm/tests/sdk.test.ts',
    'npm/tests/transport.test.ts',
    'npm/tests/worker-socket.test.ts',
    'npm/tsconfig.json',
    'python/LICENSE',
    'python/MANIFEST.in',
    'python/NOTICE',
    'python/README.md',
    'python/cedegrid/__init__.py',
    'python/cedegrid/client.py',
    'python/cedegrid/codec.py',
    'python/cedegrid/config.py',
    'python/cedegrid/errors.py',
    'python/cedegrid/process.py',
    'python/cedegrid/transport.py',
    'python/cedegrid/worker.py',
    'python/examples/counter.py',
    'python/pyproject.toml',
    'python/tests/numeric_interop.py',
    'python/tests/test_codec_config.py',
    ...
    'src/backup.rs',
    'src/cgroup.rs',
    'src/child_supervision.rs',
    'src/config.rs',
    'src/config_migration.rs',
    'src/coordinator.rs',
    'src/execution_model.rs',
    'src/execution_state.rs',
    'src/kernel.rs',
    'src/launcher_terminal.rs',
    'src/lib.rs',
    'src/main.rs',
    'src/managed_children.rs',
    'src/model.rs',
    'src/namespace.rs',
    'src/numeric.rs',
    'src/pagination.rs',
    ...
    'src/protocol.rs',
    'src/publication.rs',
    'src/publication_gc.rs',
    'src/rootless.rs',
    'src/state.rs',
    'src/storage_qualification.rs',
    'src/supervision.rs',
    'src/telemetry.rs',
    'src/upgrade.rs',
    'tests/agent.rs',
    'tests/agent_reconciliation.rs',
    'tests/artifacts.rs',
    'tests/backup.rs',
    'tests/cgroup.rs',
    'tests/cli.rs',
    'tests/configuration.rs',
    'tests/contracts/cedegrid-0.2.json',
    'tests/coordinator.rs',
    'tests/distributed_service.rs',
    'tests/execution_state.rs',
    'tests/family_contract.rs',
    'tests/gpu_native.rs',
    'tests/history_overhead.rs',
    'tests/kernel.rs',
    'tests/managed_children.rs',
    'tests/managed_supervision.rs',
    'tests/namespace.rs',
    'tests/pagination.rs',
    'tests/policy.rs',
    'tests/replay_state.rs',
    'tests/state.rs',
    'tests/storage_qualification.rs',
    'tests/supervision.rs',
    'tests/telemetry.rs',
    'tests/test_anchor_validation.py',
    'tests/test_bundle.py',
    'tests/test_compare.py',
    'tests/test_comparison_resume.py',
    'tests/test_connection_proxy.py',
    'tests/test_connection_proxy_stream.py',
    'tests/test_container_validation_profile.py',
    'tests/test_cpu_command_comparison.py',
    'tests/test_local_smoke_stress.py',
    'tests/test_operations.py',
    'tests/test_pressure_comparison.py',
    'tests/test_release_gate.py',
    'tests/test_sdk_client_transport.py',
    'tests/test_session_transfer.py',
    'tests/test_source_review.py',
    'tests/test_two_node_bootstrap.py',
    'tests/test_two_node_validation.py',
    'tests/test_validation_tools.py',
    'tests/tls_transport.rs',
    'tests/upgrade.rs',
    'tools/anchor_validation.py',
    'tools/artifact_load_qualification.py',
    'tools/build_native.py',
    'tools/build_packages.py',
    'tools/compare.py',
    'tools/connection_proxy.py',
    'tools/gpu_qualification.py',
    'tools/local_smoke.py',
    'tools/make_kaggriculture_validation.py',
    'tools/make_soak_config.py',
    'tools/make_test_pki.py',
    'tools/native_validation.py',
    'tools/pack_source_review.py',
    'tools/pack_validation.py',
    'tools/pressure.py',
    'tools/pressure_comparison.py',
    ...
    'tools/session_transfer.py',
    'tools/soak.py',
    'tools/status_benchmark.py',
    'tools/storage_qualification.py',
    'tools/two_node_bootstrap.py',
    'tools/two_node_validation.py',
    'tools/unpack_validation.py',
    'tools/validation_runtime.py',
    'tools/verify_launcher_pty.py',
    'tools/verify_package_interop.py',
    'tools/verify_python_packages.py',
)
...
def inspect_text(name, data):
    ...
    for user in re.findall(r'/(?:Users|home)/(?:students/cs/)?([^/\s"\x27`]+)', text):
        if user not in ('USER', 'user', 'test', 'cedegrid', 'example', '<USER>', '<user>') and not user.startswith(('$', '{')):
...
def pack(source, output, public=False):
    ...
    result = {'classification': manifest['classification'], 'archive': archive.name,
              ...
              'unchanged_core_sdk_and_lock_files': sum(n.startswith(('src/', 'python/cedegrid/')) or n == 'Cargo.lock' for n in files),
              'checks': checks}
